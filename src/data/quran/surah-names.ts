...
export const SURAH_NAMES: readonly SurahNaming[] = [
  ...
  { uz: "Hijr", uzMeaning: "Hijr", ru: "Аль-Хиджр", ruMeaning: "Хиджр" },
  ...
  { uz: "Furqon", uzMeaning: "Furqon", ru: "Аль-Фуркан", ruMeaning: "Различение" },
  ...
  { uz: "Inshiqoq", uzMeaning: "Yorilish", ru: "Аль-Иншикак", ruMeaning: "Разверзнется" },
  ...
  { uz: "Qoria", uzMeaning: "Daqshatli voqea", ru: "Аль-Кариа", ruMeaning: "Великое бедствие" },
  ...
  { uz: "Kavsar", uzMeaning: "Kavsar", ru: "Аль-Каусар", ruMeaning: "Изобилие" },
  { uz: "Kofirun", uzMeaning: "Kofirlar", ru: "Аль-Кафирун", ruMeaning: "Неверующие" },
  { uz: "Nasr", uzMeaning: "Nusrat", ru: "Ан-Наср", ruMeaning: "Помощь" },
  { uz: "Masad", uzMeaning: "Palma tolasi", ru: "Аль-Масад", ruMeaning: "Пальмовые волокна" },
  { uz: "Ixlos", uzMeaning: "Ixlos", ru: "Аль-Ихляс", ruMeaning: "Очищение веры" },
