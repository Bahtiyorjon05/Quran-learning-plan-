    ...
    <div className="relative min-h-dvh">
      ...
      <main className="relative z-10">
        <Measure className="py-8 sm:py-12">
          {/* One column, header and all. The cards were centred while the
              title stayed pinned to the left margin, so the page read as
              two unrelated things stacked on one screen. */}
          <div className="mx-auto max-w-xl">
            ...
            <div className="animate-rise mt-8 space-y-5 [animation-delay:80ms]">
              {!plan ? (
                ...
                <>
                  <div className="panel rounded-3xl p-5 sm:p-6">
                    ...
                    <p className="mt-2 font-[family-name:var(--font-display)] text-[1.75rem] leading-tight font-light text-[var(--text-strong)]">
                      {dateFormat.format(
                        new Date(`${plan.currentEndDate}T00:00:00Z`),
                      )}
                    </p>
                  ...
                  {spent ? (
                    ...
                    <AmendForm
                      ...
                      remainingLines={Math.max(
                        0,
                        plan.totalLines - plan.completedLines,
                      )}
                        ...
                        Math.ceil(
                          Math.max(0, plan.totalLines - plan.completedLines) /
                            Math.max(
                              ...
                              Math.round(
                                (new Date(
                                  `${plan.currentEndDate}T00:00:00Z`,
                                ).getTime() -
