    ...
    <div className="relative min-h-dvh">
      ...
      <main className="relative z-10">
        <Measure className="py-8 sm:py-12">
          {/* One column. The form was centred while the title stayed at the
              left margin, so the page read as two unrelated things sharing
              a screen. */}
          <div className="mx-auto max-w-2xl">
            ...
            <div className="animate-rise mt-8 [animation-delay:80ms]">
              <SettingsForm
                ...
                studyTime={
                  profile?.studyTime
                    ? String(profile.studyTime).slice(0, 5)
                    : ""
                }
              ...
              {plan && (
                ...
                >
                  <span className="grid h-11 w-11 shrink-0 place-items-center rounded-xl border border-gold-500/30 bg-gold-500/10">
                    <ScrollText
                      className="h-4.5 w-4.5 text-gold-ink"
                      strokeWidth={1.6}
                    />
                  </span>
